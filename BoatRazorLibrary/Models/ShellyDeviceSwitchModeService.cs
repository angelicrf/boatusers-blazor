...
{
    public class ShellyDeviceSwitchModeService : IshellyModeService
    {
        private readonly HttpClient _httpClient;

        private string ThisUri = "https://shelly-48-eu.shelly.cloud/device/relay/control";
        public ShellyDeviceSwitchModeService()
        {
